...
class EeroClient:
    ...
    def __init__(
        ...
        """
        self._api = EeroAPI(session=session, cookie_file=cookie_file)
    ...
    async def get_account(self, refresh_cache: bool = False) -> Account:
        ...
        account_data = await self._api.get_account()
    ...
    async def get_networks(self, refresh_cache: bool = False) -> List[Network]:
        ...
        networks_data = await self._api.get_networks()
        self._update_cache("networks", None, networks_data)
        
        # Set preferred network ID if not already set and we have networks
        if not self._preferred_network_id and networks_data:
            self._preferred_network_id = networks_data[0].get("id")
    ...
    async def get_network(
        ...
        network_data = await self._api.get_network(network_id)
    ...
    async def get_eeros(
        ...
        eeros_data = await self._api.get_eeros(network_id)
    ...
    async def get_eero(
        ...
        eero_data = await self._api.get_eero(network_id, eero_id)
    ...
    async def get_devices(
        ...
        devices_data = await self._api.get_devices(network_id)
    ...
    async def get_device(
        ...
        device_data = await self._api.get_device(network_id, device_id)
    ...
    async def get_profiles(
        ...
        profiles_data = await self._api.get_profiles(network_id)
    ...
    async def get_profile(
        ...
        profile_data = await self._api.get_profile(network_id, profile_id)
    ...
    async def reboot_eero(self, eero_id: str, network_id: Optional[str] = None) -> bool:
        ...
        result = await self._api.reboot_eero(network_id, eero_id)
    ...
    async def set_guest_network(
        ...
        result = await self._api.set_guest_network(network_id, enabled, name, password)
    ...
    async def set_device_nickname(
        ...
        result = await self._api.set_device_nickname(network_id, device_id, nickname)
    ...
    async def block_device(
        ...
        result = await self._api.block_device(network_id, device_id, blocked)
    ...
    async def pause_profile(
        ...
        result = await self._api.pause_profile(network_id, profile_id, paused)
    ...
    async def run_speed_test(self, network_id: Optional[str] = None) -> Dict:
        ...
        result = await self._api.run_speed_test(network_id)
